...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        await m.delete()
        m=await message.reply_sticker("CAACAgIAAxkBAAIVqGX0h72lekkCNjCXj6BHVYOdKsLbAAKmQgACYwSJS1_w3EnfAZH8NAQ")
        await asyncio.sleep(0.7)
        await m.delete()
        m=await message.reply_sticker("CAACAgIAAxkBAAIVpmX0h6EzDmH_w8VbM8cxt59peTRfAAJKPwACVPKASxcOVj07-8q6NAQ")
        await asyncio.sleep(0.5)
        await m.edit_text("<b><i>ꜱᴛᴀʀᴛɪɴɢ...</i></b>")
        await asyncio.sleep(0.7)
        await m.delete()        
        m=await message.reply_sticker("CAACAgUAAxkBAAIVfmX0hrF4EU7OweFpT6tdLFl-BamqAAKXDQAC9hLwV74v4PG8FKW3NAQ") 
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            [
             ...
             [
              InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/beautyofthemoviesx') #Don't change anything without contacting me @LazyDeveloperr
             ]
            ]
        )
    )
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>ᴄᴏᴍᴍᴀɴᴅ ɪɴᴄᴏᴍᴘʟᴇᴛᴇ !\nɢɪᴠᴇ ᴍᴇ ᴄᴏᴍᴍᴀɴᴅ ᴀʟᴏɴɢ ᴡɪᴛʜ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴀᴘɪ.\n\nꜰᴏʀᴍᴀᴛ : <code>/shortlink bindaaslinks.com 49ff923da91ec127edca47fe22d4d2d8d7514669</code>")
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/beautyofthemovie/3</code></b>")
